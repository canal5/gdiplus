...
#define GP_IT_BITMAPDATA   ( ( int ) 0x0001D )
#define GP_IT_CACHEDBITMAP ( ( int ) 0x0001E )
...
#define GP_IS_BITMAPDATA( p )     ( GP_OBJECT_TYPE( p ) == GP_IT_BITMAPDATA )
#define GP_IS_CACHEDBITMAP( p )   ( GP_OBJECT_TYPE( p ) == GP_IT_CACHEDBITMAP )
